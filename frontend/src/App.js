...
import Activity from "./Pages/Activity"; // Add this import
    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route path="/lessons/:lessonId/quiz" element={user ? <QuizPage /> : <Navigate to="/" />} />
                <Route path="/quiz" element={<QuizPage />} />
                <Route path="/study-sessions" element={user ? <StudyCalendar /> : <Navigate to="/" />} />
                <Route path="/profile" element={user ? <ProfilePage /> : <Navigate to="/" />} />
                <Route path="/activity" element={user ? <Activity /> : <Navigate to="/" />} /> {/* Add this route */}
